  ...
  return (
    <div className="auth-shell">
      ...
      >
        ...
        <p>Initialize your operative profile — unlock roles, missions, and real-time holo-canvas operations.</p>
      ...
      >
        ...
        <p>Set up your operative identity.</p>
        ...
        <div className="auth-footer">
          Already enlisted? <Link to="/login">Authenticate</Link>
        </div>
      </motion.div>
    </div>
  );
